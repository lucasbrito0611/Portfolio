    ...
    return (
        <form ref={form} onSubmit={sendEmail} className='flex flex-col gap-12 nt-lg:w-1/2 nt-sm:w-[45%] w-full'>
            <motion.div className='flex flex-col gap-4' variants={slideInFromLeft(1, 0.6)} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <input type="text" name='name' placeholder='Digite o seu e-mail' className='pb-3 pl-3 outline-none text-mid-blue text-lg border-b-[1px] border-bright-green'/>
            </motion.div>
            <motion.div className='flex flex-col gap-2' variants={slideInFromLeft(1, 0.8)} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <input type="text" name='subject' placeholder='Digite o seu assunto' className='pb-3 pl-3 outline-none text-mid-blue text-lg border-b-[1px] border-bright-green'/>
            </motion.div>
            ...
            <motion.button type='submit' variants={slideInFromLeft(1, 1.2)} initial="hidden" whileInView="visible" viewport={{ once: true }}>
